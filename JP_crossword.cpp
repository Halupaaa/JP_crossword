...
int main()
{
    vector<vector<int>> top_hints_5 = { {1,1}, {2,1}, {1,1,1}, {1,2}, {1,1} };
    vector<vector<int>> left_hints_5 = { {5}, {1}, {1}, {1}, {5} };
    vector<vector<int>>hints_5[2] = { top_hints_5 , left_hints_5 };
